...
//            }
    ...
    public static void install(Context context) {
        ...
        Uri apkUri =
                FileProvider.getUriForFile(context, "com.fchj.czglgz.chengzhangguanli_high.fileprovider", file);
            ...
            switch (msg.what) {
                case DOWN_SUCCESS:
                    ...
                    if (auto_Install) {
                        ...
                        if (Build.VERSION.SDK_INT >= 24) {
                            Uri apkUri = FileProvider.getUriForFile(DownloadService.this, "com.fchj.czglgz.chengzhangguanli_high.fileprovider", updateFile);
                            intent.addFlags(Intent.FLAG_GRANT_READ_URI_PERMISSION);
                            intent.setDataAndType(apkUri, "application/vnd.android.package-archive");
                        } else {
