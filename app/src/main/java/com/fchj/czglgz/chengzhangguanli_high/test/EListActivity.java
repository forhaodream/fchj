...
public class EListActivity extends AppCompatActivity {
...
//        子项点击事件
        listview.setOnChildClickListener(new ExpandableListView.OnChildClickListener() {
            ...
            public boolean onChildClick(ExpandableListView expandableListView, View view,
               ...
               /* Toast.makeText(EListActivity.this,
...
//        实现思路，Parent中有一个List<Child>对象，解析json的时候解析出
    ...
    private class MyExpandableListViewAdapter extends BaseExpandableListAdapter {
        ...
        public int getGroupCount() {
            if (datasets == null) {
                Toast.makeText(EListActivity.this, "dataset为空", Toast.LENGTH_SHORT).show();
                return 0;
            }
        ...
        public int getChildrenCount(int parentPos) {
            if (datasets.get(PList[parentPos]) == null) {
                Toast.makeText(EListActivity.this, "\" + parentList[parentPos] + \" + 数据为空", Toast.LENGTH_SHORT).show();
                return 0;
            }
        ...
        public View getGroupView(int parentPos, boolean b, View view, ViewGroup viewGroup) {
            if (view == null) {
                LayoutInflater inflater = (LayoutInflater) EListActivity
