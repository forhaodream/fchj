...
public class CollegeListDetailAdapter extends BaseAdapter {
    private List<CollegeListDetailModel.DataBean.LuadtiBean> mData;
    // private ImageView mImageView;

    public CollegeListDetailAdapter(List<CollegeListDetailModel.DataBean.LuadtiBean> data) {
        this.mData = data;
    }
