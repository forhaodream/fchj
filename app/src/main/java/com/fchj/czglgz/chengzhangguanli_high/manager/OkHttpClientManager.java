package com.fchj.czglgz.chengzhangguanli_high.manager;
...
import com.fchj.czglgz.chengzhangguanli_high.util.ImageUtils;
...
public class OkHttpClientManager {
     ...
     * @throws IOException
     */
    private void _postAsyn(String url, StringCallback callback, File file, String fileKey) {
        Request request = buildMultipartFormRequest(url, new File[]{file}, new String[]{fileKey}, null);
        deliveryResult(callback, request);
    }
    ...
    public static void postAsyn(String url, StringCallback callback, File file, String fileKey) {
