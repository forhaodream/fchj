...
public class PopupOsCollegeAdapter extends BaseAdapter {
    private List<OsStudyModel.DataBean> mData;

    public PopupOsCollegeAdapter(List<OsStudyModel.DataBean> data) {
        this.mData = data;
    }
